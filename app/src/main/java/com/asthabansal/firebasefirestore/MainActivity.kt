        ...
        binding.fab.setOnClickListener {
            ...
            dialogbinding.btnAdd.setOnClickListener {
                if (dialogbinding.etTitle.text.toString().isEmpty()) {
                    ...
                    firestore.collection("User")
                        .add(
                        NotesDataClass(title = dialogbinding.etTitle.text.toString(),
    ...
    override fun btnupdate(position: Int) {
        ...
        dialogbinding.btnAdd.setOnClickListener {
            if (dialogbinding.etTitle.text.toString().isEmpty()) {
                ...
                var updateItem = NotesDataClass(title = dialogbinding.tvTitle.text.toString(),
                description = dialogbinding.tvDescription.text.toString(),
